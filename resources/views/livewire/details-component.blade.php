                    ...
                    <div class="detail-info">
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-reduce" href="#" wire:click.prevent="DecreaseQuatity"></a>
                                                    ...
                                                    <div id="comment-20" class="comment_container">
                                                        ...
                                                        <div class="comment-text">
                                                            <div class="star-rating">
                                                                <span class="width-{{ $orderItem->rating * 20 }}-percent">Rated <strong
                                                                        class="rating">{{ $orderItem->rating }}</strong> out of 5</span>
                                                            </div>
                                                            <p class="meta">
                                    ...
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{ route('product.details', ['slug' => $popular_product->slug]) }}"
                                                title="{{ $popular_product->regular_price }}">
                                                <figure><img
