                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="confirm('Are You sure, You want to to delete this product?') || event.stopImmediatePropagation()" wire:click.prevent="deleteProduct({{ $product->id }})"
                                                style="margin-left: 10px" ><i class="fa fa-times fa-2x"
                                                    style="color: red"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
