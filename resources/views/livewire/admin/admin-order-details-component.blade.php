                    ...
                    <div class="panel-body">
                            ...
                            <ul class="products-cart">
                                @foreach ($order->orderItems as $item)
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="quantity">
                                            <h4 class="text-center pb-1">{{ $item->quantity }}</h4>
                                        </div>
                        ...
                        <div class="summary">
                            <div class="order-summary">
                                <div class="title-box">
                                    <h4 class="title-box">Order Summart</h4>
                                    <p class="summary-info total-info "><span class="title">Subtotal</span><b
                                            class="index">${{ $order->subtotal }}</b></p>
                                    <p class="summary-info total-info "><span class="title">Tax</span><b
                                            class="index">${{ $order->tax }}</b></p>
                                    <p class="summary-info total-info "><span class="title">Shipping</span><b
