                            ...
                            @if (!Session::has('coupon'))
                                <label class="checkbox-field">
                                    <input class="frm-input " name="have-code" id="have-code" value="1"
                                        type="checkbox" wire:model="haveCouponCode"><span>I have Coupon code</span>
                                </label>
                                @if ($haveCouponCode == 1)
                                    <div class="summary-info">
                                        <form class="form-inline" wire:submit.prevent="applyCoupon()">
                                            ...
                                            @endif
                                            <p class="form-group mx-sm-3 mb-2">
                                                <label for="coupon-code">Enter Your Coupon Code:</label>
                                                <input type="text" name="coupon-code" class="form-control"
                                                    wire:model="couponCode">
                                            </p>
                                            <button type="submit" class="btn btn-samll btn-danger">Apply</button>
                                        </form>
                                    </div>
                                @endif
                            @endif
                            <a class="btn btn-checkout" href="#" wire:click.prevent="checkout">Check out</a>
                            <a class="link-to-shop" href="/shop">Continue Shopping<i
                                    class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                        </div>
                        <div class="update-clear">
                            <a class="btn btn-clear" wire:click.prevent="clearAll()">Clear Shopping Cart</a>
                        ...
                        <ul class="products-cart">
                            @foreach (Cart::instance('saveForLater')->content() as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="delete">
                                        <a wire:click.prevent="deleteFromSaveLater('{{ $item->rowId }}')"
                                            class="btn btn-delete" title="">
