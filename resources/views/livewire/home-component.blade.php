                        ...
                        @foreach ($sale_products as $sale_product)
                            <div class="product product-style-2 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price " style="margin-right: 7px; color: red">${{ $sale_product->sale_price }} </span> <del><p class="product-price"> {{ $sale_product->regular_price }}</p></del></div>
                                </div>
                            </div>
                        @endforeach
                    </div>
